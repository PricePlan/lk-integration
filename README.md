...
5. Данный ресурс должен вернуть редирект вида https://&lt;субдомен\_клиента&gt;-lk.priceplan.pro/auth-key/&lt;**priceplan\_auth\_key**&gt;/
...
https://&lt;субдомен\_клиента&gt;-lk.priceplan.pro/auth-key/&lt;**priceplan\_auth\_key**&gt;/
